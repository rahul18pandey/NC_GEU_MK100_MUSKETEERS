                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Stack(
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              (AppLocalizations.of(context).translate('79')),
                              style:
                      ...
                      Align(
                        ...
                        child: RaisedButton(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text(
                                (AppLocalizations.of(context).translate('79')).toUpperCase(),
                                style: TextStyle(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Text((AppLocalizations.of(context).translate('80')),style: TextStyle(fontSize: 20),),
                          FlatButton( child: Text((AppLocalizations.of(context).translate('75'))+"!",style: TextStyle(fontSize: 20,color: Colors.blue),),
                            onPressed: (){
