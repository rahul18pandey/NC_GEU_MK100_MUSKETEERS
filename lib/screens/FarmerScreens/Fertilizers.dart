...
class _FertilizersState extends State<Fertilizers> {
  ...
  Widget build(BuildContext context) {
    if (servicedata1 != null && servicedata!=null) {
      ...
      return new Scaffold(
          ...
          appBar: AppBar(
            centerTitle:true,
            title: Text((AppLocalizations.of(context).translate('11')), textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w600),),
  ...
  Widget buildTransportationCard(BuildContext context, int i) {
    ...
    if ("fertilizer/pesticides" == servicedata1.documents[i].data['Type']) {
