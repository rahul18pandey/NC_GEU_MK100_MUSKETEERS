...
class IrrigationSystem extends StatefulWidget {
  @override
  _IrrigationSystemState createState() => _IrrigationSystemState();
}

class _IrrigationSystemState extends State<IrrigationSystem> {
  ...
  Widget build(BuildContext context) {
    if (servicedata1 != null && servicedata!=null) {
      ...
      return new Scaffold(
          ...
          appBar: AppBar(
            centerTitle:true,
            title: Text((AppLocalizations.of(context).translate('9')), textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w600),),
  ...
  Widget buildTransportationCard(BuildContext context, int i) {
    ...
    if ("irrigation" == servicedata1.documents[i].data['Type']) {
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(children: <Widget>[
                  Text(servicedata1.documents[i].data['Type'].toString().toUpperCase(),
                    style: new TextStyle(
