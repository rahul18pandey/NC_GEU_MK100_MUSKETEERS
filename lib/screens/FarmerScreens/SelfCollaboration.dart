        ...
        return SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Container(
                margin: EdgeInsets.only(top: 15,right: width/5),
                child: Text("Documents Required for Factory Registration",style: TextStyle(fontWeight: FontWeight.bold,decoration: TextDecoration.underline),),
              ),
              Container(
                  margin: EdgeInsets.all(10),
              ...
              Container(
                ...
                child: Text("Step 4 - No pollution certificate:",style: TextStyle(fontWeight: FontWeight.bold),),
              ),
              Container(
                  margin: EdgeInsets.all(10),
                  child: Text("Apply for ‘consent to operate’ and ‘consent to establish’ from the Pollution Control Board Acts 1958: Apply for the Rice-Milling Industry (Regulation) Act, 1958.")
              ),
              Container(
                margin: EdgeInsets.only(top: 10,right: width/2.7),
                child: Text("Step 5 - PFA and ESIC Registration:",style: TextStyle(fontWeight: FontWeight.bold),),
              ),
              Container(
                  margin: EdgeInsets.all(10),
