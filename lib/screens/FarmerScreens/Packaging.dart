...
class _PackagingState extends State<Packaging> {
  ...
  Widget build(BuildContext context) {
    if (servicedata1 != null&&servicedata!=null) {
      ...
      return new Scaffold(
          ...
          appBar: AppBar(
            centerTitle:true,
            title: Text((AppLocalizations.of(context).translate('12')), textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w600),),
  ...
  Widget buildTransportationCard(BuildContext context, int i) {
    ...
    if ("packaging" == servicedata1.documents[i].data['Type']) {
