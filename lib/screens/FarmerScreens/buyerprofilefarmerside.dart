...
class BidderProfile extends StatefulWidget {

  final String user;

  const BidderProfile({Key key, this.user}) : super(key: key);
  @override
  _BidderProfilePageState createState() => _BidderProfilePageState();
}

class _BidderProfilePageState extends State<BidderProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    if(buyerprofiledata!=null&&transactiondata!=null) {
        ...
        for(int i=0;i<transactiondata.documents.length;i++){
          if(transactiondata.documents[i].data['Email']==widget.user){
  ...
  _showProfile(){
    if (buyerprofiledata!= null) {
      ...
      {
        if(widget.user==buyerprofiledata.documents[i].documentID)
        {
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            fobj.addchatuser({
                              'reciever email':widget.user,
                            },widget.user).then((result) {
                            }).catchError((e) {
                              print(e);
                            });
                            fobj.addchatuser1({
