...
class _TransportationState extends State<Transportation> {
    ...
    if (servicedata1 != null && servicedata!=null) {
      ...
      return new Scaffold(
          ...
          appBar: AppBar(
            centerTitle:true,
            elevation: 0,
            title: Text((AppLocalizations.of(context).translate('8')), textAlign: TextAlign.center,style: TextStyle(fontFamily: 'Montserrat',fontWeight: FontWeight.w600),),
  ...
  Widget buildTransportationCard(BuildContext context, int i) {
    ...
    if ("transport" == servicedata1.documents[i].data['Type']) {
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(padding: const EdgeInsets.only(top: 4.0, bottom: 10.0),
              child: Row(
                children: <Widget>[
                  Text(
